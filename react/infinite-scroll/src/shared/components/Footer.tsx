function Footer(){
    return (
        <section className="footer-container bg-gray-300 flex items-center justify-center  p-2 space-x-4">
             <a href="https://www.linkedin.com/in/kumaravishekfe/" 
                className="flex flex-row items-center justify-content-between hover:font-bold transition-0.3"
                target="_blank" 
                aria-label="Kumar Avishek Linkedin Profile">
                Linkedin
             </a>
             <a href="https://github.com/iamkravishek" 
                className="flex flex-row items-center justify-content-between hover:font-bold transition-0.3"
                target="_blank" 
                aria-label="Kumar Avishek Github Profile">
                <span>
                    <svg height="20" aria-hidden="true" viewBox="0 0 12 12" version="1.1" width="20" data-view-component="true" fill="currentColor">
